...
export default function PresentationCard({ p, cardHeight }) {
  ...
  if (!p || typeof p !== "object") {
    return (
      <div className="rounded-xl border-2 border-gray-200 shadow-sm overflow-hidden bg-white h-[var(--card-h)] flex flex-col">
  ...
  return (
    ...
    >
      {/* Fixed image band height for consistency */}
